# PUBLISH CHECKLIST — product-02 Poetcore Pen-Pal Kit (copy-paste launch)
...
- [ ] Price $8.95 → publish. Target: before October (cozy gifting season)
## Pinterest (~10 min)
- [ ] 3 pins from spec file, 1/day. Boards: Journaling, Bookish Gifts, Snail Mail
## Done looks like
5 sales → add wax-seal how-to video pin (highest-converting format for this niche).
